...
cards=[{:card_value=>'A',:card_suit=>'S',:pile_id=>0},
       {:card_value=>'2',:card_suit=>'S',:pile_id=>0},
       {:card_value=>'3',:card_suit=>'H',:pile_id=>0},
       {:card_value=>'K',:card_suit=>'D',:pile_id=>0},
       {:card_value=>'Q',:card_suit=>'C',:pile_id=>0},
       {:card_value=>'J',:card_suit=>'H',:pile_id=>0},
       {:card_value=>'6',:card_suit=>'D',:pile_id=>0}]
